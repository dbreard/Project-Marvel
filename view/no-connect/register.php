...
<head>
    ...
    <?php require_once __DIR__."/../include/head.inc.php"; //récuperer le fichier head.inc.php dans le dossier include ?>
		...
		<div class="form d-flex align-items-center">
		  <div class="content">
			<form id="register-form" method="post" action="<?= HOSTURL ?>" >
				<!-- afin de connaitre l'origine du formulaire -->
...
<div class="copyrights text-center">
  ...
  <!-- Please do not remove the backlink to us unless you support further theme's development at https://bootstrapious.com/donate. It is part of the license conditions. Thank you for understanding :)-->
    ...
    <?php require_once __DIR__."/../include/footer.inc.php"; //récuperer le fichier footer.inc.php dans le dossier include ?>
</body>
